...
public class WorkHouse {
	...
	public Float getAvg_time_dust() {
		return avg_time_dust;
	}

	public void setAvg_time_dust(Float avg_time_dust) {
	...
	public Float getAvg_time_night() {
		return avg_time_night;
	}

	public void setAvg_time_night(Float avg_time_night) {
	...
	public Float getAvg_time_leave() {
		return avg_time_leave;
	}

	public void setAvg_time_leave(Float avg_time_leave) {
