...
public class HotelCustomerServiceImpl implements HotelCustomerService{
	 ...
	 *            向指定字段插入序号
	 */
	private void sortAndWrite0(List<HouseCustomerServiceLoad> list, String filedName, boolean ascFlag, String writeField) {
		CollectionUtil.sort(list, filedName, ascFlag);
	 ...
	 *            向指定字段插入序号
	 */
	private void sortAndWrite1(List<HouseCustomerServiceType> list, String filedName, boolean ascFlag, String writeField) {
		CollectionUtil.sort(list, filedName, ascFlag);
