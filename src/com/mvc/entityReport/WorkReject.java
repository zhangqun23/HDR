...
public class WorkReject {
	...
	public String getReject_dust_eff() {
		return reject_dust_eff;
	}
	public void setReject_dust_eff(String reject_dust_eff) {
	...
	public String getReject_night_eff() {
		return reject_night_eff;
	}
	public void setReject_night_eff(String reject_night_eff) {
	...
	public String getReject_leave_eff() {
		return reject_leave_eff;
	}
	public void setReject_leave_eff(String reject_leave_eff) {
